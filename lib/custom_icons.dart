...
class CustomIcons {
  ...
  static const IconData wiThermometer = IconData(0xe990, fontFamily: _kFontFam);
  static const IconData wiThermometerExterior =
      IconData(0xe991, fontFamily: _kFontFam);
  static const IconData wiHumidity = IconData(0xe90f, fontFamily: _kFontFam);
  static const IconData wiFog = IconData(0xe908, fontFamily: _kFontFam);
